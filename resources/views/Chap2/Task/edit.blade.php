    ...
    <div class="ui segment">
      <form class="ui form" >
        ...
        <div class="ui small basic icon buttons">
          <a href="/chap2/task/list" class="ui button"><i class="delete icon"></i></a>
...
@section('javascript')
<!-- <script src="{{ asset('js/Chap2/Task/view.js')}}"></script> -->
<!-- <script src="{{ asset('js/Chap2/Task/update.js')}}"></script> -->
@stop
