...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <body>
        ...
        <form action="/Chapter1/task/test/{{$task->id}}/store" method="post">
            {{ csrf_field() }}
            {{ method_field("PUT") }}
         <!--  <input type="hidden" name="_method" value="put" /> -->
            <div class="container">
              ...
              <textarea name="body"><?php echo  $task->body  ?></textarea>
        ...
        <form action="/Chapter1/task/test/{{$task->id}}/delete" method="post">
          {{ csrf_field() }}
          {{ method_field("DELETE") }}
          <button type="submit" style="color:White;background-color: #ff0015;" >Delete</button>
        </form>  
